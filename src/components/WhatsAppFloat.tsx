...
export default function WhatsAppFloat() {
    ...
    return (
        ...
        >
            {/* Call Button */}
            <a
                href="tel:+995574215092"
                aria-label="Call us"
                className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full
                           bg-caramel text-white shadow-lg shadow-caramel/30
                           transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-caramel/40
                           active:scale-95"
            >
